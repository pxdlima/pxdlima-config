...
cd vpnserver && make i_read_and_agree_the_license_agreement && rm *.txt && curl -Os https://raw.githubusercontent.com/pxdlima/pxdlima-config/master/vpn_server.config
